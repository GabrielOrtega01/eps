...
<head>
    ...
    <title>Consulta de Cliente y Citas</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/4.6.0/css/bootstrap.min.css">
</head>
<body>
    <div class="container">
        <h1>Consulta de Cliente y Citas</h1>
            ...
            <tbody>
                <% // Java code for database connection and data retrieval
                    ...
                    if (idCliente != null) {
                        ...
                        // Handle case where idCliente is not in session
                        out.println("<tr><td colspan='6'>Error: No se ha iniciado sesión o falta el identificador del cliente.</td></tr>");
                    }
                %>
            </tbody>
        </table>
