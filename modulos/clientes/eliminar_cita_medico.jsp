...
<head>
    ...
    <title>Eliminar Cita con el Médico</title>
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css">
</head>
<body>
    <div class="container">
        <h1 class="mt-5 mb-4">Eliminar Cita con el Médico</h1>
        <form method="post">
                ...
                <select class="form-control" id="citaMedica" name="citaMedica_id">
                    <% 
                        ...
                        try {
                            ...
                            // Consulta para obtener las citas médicas del cliente
                            String selectSQL = "SELECT cm.idcitaMedica, cm.fecha, cm.hora, m.nombre, m.apellido, m.especialidad " +
                                              "FROM citamedica cm " +
                            ...
                            while (rs.next()) {
                                ...
                                String nombreMedico = rs.getString("nombre") + " " + rs.getString("apellido");
                                String especialidadMedico = rs.getString("especialidad");
                    %>
                    <option value="<%= idCitaMedica %>">
                        <%= "Fecha: " + fecha + " - Hora: " + hora + " - Médico: " + nombreMedico + " (" + especialidadMedico + ")" %>
                    </option>
