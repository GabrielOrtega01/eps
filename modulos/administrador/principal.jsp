...
<head>
    ...
    <style>
        body {
            ...
            margin: 0;
            padding: 0;
            background-image: src="img/logotipo.png"url('fondo.png');
...
<body>
 <img src="img/fondo.png" alt="Logotipo" class="background-img">
    <div class="container">
        ...
        <div class="options">
            ...
            <div class="option">
                <a href="mostrar_clientes.jsp">Mostrar todos los clientes</a>
            </div>
            <div class="option">
                <a href="crear_cliente.jsp">Crear cliente</a>
            </div>
            <div class="option">
                <a href="actualizar_clientes.jsp">Actualizar clientes</a>
            </div>
            <div class="option">
                <a href="eliminar_clientes.jsp">Eliminar clientes</a>
            </div>
            <div class="option">
                <a href="mostrar_medicos.jsp">Mostrar todos los médicos</a>
            </div>
            <div class="option">
                <a href="crear_medico.jsp">Crear médico</a>
            </div>
            <div class="option">
                <a href="actualizar_medicos.jsp">Actualizar médicos</a>
            </div>
            <div class="option">
                <a href="eliminar_medicos.jsp">Eliminar médicos</a>
            </div>
            <div class="option">
            ...
            <div class="option">
                <a href="ingresar_cita_laboratorio.jsp">Ingresar Cita con el Laboratorio</a>
            </div>
            <div class="option">
                <a href="mostrar_cita_laboratorio.jsp">Mostrar Cita con el Laboratorio</a>
            </div>
            <div class="option">
                <a href="actualizar_cita_laboratorio.jsp">Actualizar Cita con el Laboratorio</a>
            </div>
            <div class="option">
                <a href="eliminar_cita_laboratorio.jsp">Eliminar Cita con el Laboratorio</a>
            </div>
<div class="option">
