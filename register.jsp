...
<head>
    ...
    <title>Crear Cliente - EPS Securitas</title>
    <!-- Bootstrap CSS -->
...
<body>
    <div class="container">
        <h1 class="mt-5 mb-4">Crear Nuevo Cliente</h1>
        ...
        <form action="" method="post">
            ...
            <!-- Botón de regresar -->
            <button type="button" class="btn btn-secondary" onclick="location.href='login.jsp';">Volver</button>
        </form>
        <% 
            ...
            if ("POST".equals(request.getMethod())) {
                ...
                try {
                    ...
                    String insertSQL = "INSERT INTO cliente (documento, nombre, apellido, estadoCivil, direccion, correo, clave) VALUES (?, ?, ?, ?, ?, ?, ?)";
        ...
        %>
        <div class="alert alert-success mt-3">Cliente creado exitosamente</div>
        <%          } else { %>
